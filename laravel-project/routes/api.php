...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::apiResource('conferences', ConferenceController::class)->except(['update', 'destroy']);


    Route::middleware('can.manage.conference')->group(function () {
    ...
    Route::get('/conferences/{conferenceId}/subpages/{subpage}', [SubpageController::class, 'show']);


    Route::middleware('can.manage.subpage')->group(function () {
        Route::put('/conferences/{conferenceId}/subpages/{subpage}', [SubpageController::class, 'update']);
        Route::delete('/conferences/{conferenceId}/subpages/{subpage}', [SubpageController::class, 'destroy']);
    });
